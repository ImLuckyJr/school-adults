<template>
  <section id="register" class="section tw-flex tw-flex-row tw-mt-10">
    <div class="tw-w-full tw-mb-32">
      <v-form ref="registerForm" v-model="formValid" lazy-validation>
        <div class="title">
          <h2>Регистрация</h2>
        </div>
        ...
        <div class="tw-flex tw-flex-row tw-gap-x-32 tw-mb-4">
          <div
            ...
            "
          >
            <div class="btn-auth google">Продолжить с помощью Google</div>
          </div>
          ...
          <div
            ...
            "
          >
            <div class="btn-auth vk">Продолжить с помощью ВКонтакте</div>
          </div>
        </div>
    ...
    formRules() {
      return {
        ...
        password: [
          ...
          (v) =>
            (v && v.length <= 50) || "Максимальная длина пароля - 50 символов",
        ],
        ...
        birthday: [
          ...
          (v) =>
            ...
            v === null ||
            v === "" ||
            new Date(v.split(".").reverse().join("/")).getTime() <=
              Date.now() ||
