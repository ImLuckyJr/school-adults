<template>
  <header class="tw-flex tw-flex-row tw-justify-between tw-py-5">
    <div class="header__left tw-flex tw-flex-row">
      <div
        class="logo 2xl:tw-mr-32 xl:tw-mr-32 lg:tw-mr-24 md:tw-mr-24 sm:tw-mr-16"
      >
        <a href="/">
          <object
      ...
      <div class="links tw-flex tw-flex-row tw-items-stretch tw-gap-9">
        ...
        >
          <NuxtLink v-if="$route.name !== 'index'" to="/">Главная </NuxtLink>
        ...
        <div
          ...
          class="link__item tw-flex tw-items-center"
        >
          <NuxtLink v-if="$route.name !== 'courses'" to="/courses"
            >Курсы
          </NuxtLink>
    ...
    <div class="header__right tw-flex tw-flex-row">
      <div class="links tw-flex tw-flex-row tw-items-stretch">
        <div
          ...
          v-if="!$auth.loggedIn"
        >
          <v-menu right :nudge-left="50" content-class="header-menu" offset-y>
        ...
        <div v-else>
          <div right :nudge-left="50" content-class="header-menu" offset-y>
            {{ $auth.user.first_name }} {{ $auth.user.last_name }}
            <img :src="$auth.user.photo" alt="" /><a
              href="#"
              @click="$auth.logout()"
              >Выход</a
            >
